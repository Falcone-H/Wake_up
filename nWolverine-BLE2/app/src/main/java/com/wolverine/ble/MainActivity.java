...
public class MainActivity extends Activity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
    ...
    RadioGroup mRg;
    private String cur_message = null;
    ...
    private Button btn_oxygen;
    private Button btn_pressure;
    private Button btn_sugar;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_oxygen = (Button) findViewById(R.id.btn_oxygen);
        ...
        btn_oxygen.setOnClickListener(this);
                 ...
                 runOnUiThread(new Runnable() {
                     public void run() {
                         try {
                         	...
                         	String currentDateTimeString = DateFormat.getTimeInstance().format(new Date());
                     		listAdapter.add("["+currentDateTimeString+"] "+cur_message +" : "+text);
                    	 	messageListView.smoothScrollToPosition(listAdapter.getCount() - 1);
                    	 	setEnabled(true);
                         } catch (Exception e) {
    ...
    public void setEnabled(boolean flag) {
        btn_heart.setEnabled(flag);
        btn_oxygen.setEnabled(flag);
        btn_pressure.setEnabled(flag);
        btn_sugar.setEnabled(flag);
        btn_step.setEnabled(flag);
        btn_calories.setEnabled(flag);
    }
}
